...
export default async function LoginPage({ searchParams }: LoginPageProps) {
  ...
  return (
    <main className="grid h-dvh w-dvw overflow-hidden md:grid-cols-2">
      {/* Sol — görsel */}
      ...
      <section className="flex h-full min-h-0 flex-col bg-white">
        <div className="border-b border-zinc-100 px-8 py-5 md:hidden">
          <p className="text-center text-base font-medium tracking-tight text-zinc-900">
            Peritas Panel
          </p>
        </div>
