...
function Toasts({ position }: { position: ToastPosition }): React.ReactElement {
  ...
  return (
    <Toast.Portal data-slot="toast-portal">
      <Toast.Viewport
        className={cn(
          "pointer-events-none fixed z-[200] mx-auto flex w-[calc(100%-var(--toast-inset)*2)] max-w-90 overflow-visible [--toast-inset:--spacing(4)] sm:[--toast-inset:--spacing(8)]",
          ...
          return (
            ...
            >
              <Toast.Content
                ...
                className="pointer-events-auto flex cursor-pointer items-center justify-between gap-1.5 overflow-hidden px-3.5 py-3 text-sm transition-opacity duration-250 data-behind:not-data-expanded:pointer-events-none data-behind:opacity-0 data-expanded:opacity-100"
              >
